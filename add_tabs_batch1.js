...
${ib('Senior (7+ years)', p4)}
          ...
          <div class="breed-section">
            ...
            <p>These amounts are based on a standard quality dry kibble (~350 kcal/cup). Always check the feeding chart on your specific brand and adjust for your dog's activity level.</p>
            <div class="info-grid">
${rows}
            </div>
          </div>
...
breeds['golden-retriever'] = {
  ...
  facts: factsPanel(
    ...
    [
      ...
      '🧬 Approximately <strong>60% of all Golden Retrievers develop cancer</strong> — the highest rate of any breed. The Morris Animal Foundation enrolled 3,000+ Goldens in a landmark lifetime study.',
      ...
      '🥚 Goldens have an incredibly <strong>"soft mouth"</strong> — bred to retrieve birds without damage. They are so gentle they can carry a raw egg in their mouth without cracking it.',
      ...
      '🏊 Their <strong>water-repellent double coat and webbed toes</strong> make them natural-born swimmers, capable of retrieving from cold water for hours without fatigue.',
      '🌟 Goldens are among the most popular <strong>therapy and emotional support dogs</strong> — hospitals and schools use them because they measurably reduce anxiety in patients and students.',
    ],
    [
      ["Air Buddy", "Golden who played basketball in the 1997 film 'Air Bud,' launching a beloved multi-movie franchise"],
      ["Shadow (Homeward Bound)", "Wise, devoted Golden in the 1993 film — one of cinema's most beloved dog performances"],
      ["Liberty", "First Golden Retriever to live in the White House — owned by President Gerald Ford in the 1970s"],
...
breeds['german-shepherd'] = {
  ...
  cost: costPanel(
    ...
    '$20,000 – $40,000',
    ['First-year costs are high — obedience training classes are essential, not optional, for German Shepherds',
  ...
  facts: factsPanel(
    ...
    [
      '🔢 German Shepherds are the <strong>#2 most popular breed in the USA</strong> — and have consistently ranked in the top 3 worldwide for decades.',
      "🪖 GSDs are the <strong>most widely used breed in police and military work globally</strong> — serving in drug detection, bomb sniffing, search and rescue, and personal protection.",
      ...
      "🦴 German Shepherds were <strong>the first breed trained as guide dogs for the blind</strong> — the program began in Germany after WWI to help veterans who lost their sight in combat.",
      "🧠 GSDs rank <strong>3rd in canine intelligence</strong> (behind only Border Collies and Poodles) — they learn a new command in fewer than 5 repetitions and obey it 95%+ of the time.",
      ...
      '🌍 During WWII, the US renamed them <strong>"Alsatians"</strong> to remove the German association — a name that is still used in parts of the UK and Ireland today.',
      "⚕️ German Shepherds are one of the leading breeds used in <strong>medical scent detection</strong> — research shows they can identify certain cancers with up to 98% accuracy.",
      '🏃 A healthy adult GSD can run at speeds of <strong>up to 30 mph</strong> — making them the preferred breed for K9 pursuit and apprehension work worldwide.',
    ],
    [
      ["Rin Tin Tin", "WWI rescued GSD turned Hollywood's first major animal star — appeared in 26 films and saved Warner Bros."],
      ...
      ["Rex (Kommissar Rex)", "Famous police GSD who starred in a long-running Austrian TV series watched by millions across Europe"],
    ]
  ),
};
...
breeds['french-bulldog'] = {
  ...
  mixes: mixesPanel(
    ...
    [
      ['🐕', 'Frenchton (French Bulldog + Boston Terrier)',
       ...
       [['Size', '15 – 25 lbs'], ['Breathing', 'Somewhat better than purebred'], ['Energy', 'Moderate'], ['Price', '$1,500 – $3,500']]],
  ...
  facts: factsPanel(
    ...
    [
      ...
      "🇬🇧 Despite the name, French Bulldogs were actually <strong>developed in England</strong>. English lace workers created miniature Bulldogs, then brought them to France for work. Parisians fell in love.",
      ...
      "👶 French Bulldogs <strong>cannot reproduce naturally in most cases</strong> — their puppies' large heads can't pass through the birth canal, so most litters require C-section delivery.",
      ...
      '👂 The <strong>bat ear</strong> is the breed\'s defining feature — developed by French breeders who standardized it when English breeders preferred the "rose ear" fold.',
      "🏙️ Frenchies are the <strong>ultimate city dog</strong> — minimal exercise needs, quiet demeanor, compact size, and total devotion to their owner. No wonder they dominate in Paris, NYC, and London.",
      "🧬 The flat-face trait is caused by a <strong>single gene mutation (BMP3)</strong> that breeders have intensified since the 1800s — a reminder of how selective breeding shapes a dog's health.",
      "💎 French Bulldogs are <strong>owned by more celebrities</strong> than any other breed — Lady Gaga, The Rock, Leonardo DiCaprio, Hugh Jackman, and Reese Witherspoon are all devoted Frenchie fans.",
    ],
    [
      ["Koji & Gustav (Lady Gaga's Frenchies)", "Famously stolen at gunpoint in 2021 — the thief was convicted and both dogs were recovered unharmed"],
      ["Stella (Modern Family)", "Jay Pritchett's beloved Frenchie on the hit TV series, appearing in multiple memorable storylines"],
      ["Grimm (Martha Stewart's Frenchie)", "Martha Stewart's French Bulldog became a social media star featured across her platforms"],
      ["Gigi (The Rock's Frenchie)", "Dwayne Johnson's French Bulldog achieved viral fame and inspired a heartfelt tribute after her passing"],
    ]
  ),
};
...
function process(filename, breedKey) {
  ...
  // Normalize CRLF → LF so patterns match consistently
  ...
  //    (10-space </div> closes video-embed, 8-space </div> closes breed-section)
  const old1 = '          </div>\n        </div>\n\n        <div class="breed-section">\n          <h2>🐾 Overview</h2>';
  const new1 = '          </div>\n        </div>\n\n' + TAB_NAV + '\n        <div class="breed-section">\n          <h2>🐾 Overview</h2>';
  if (!html.includes(old1)) throw new Error(`Pattern 1 not found in ${filename}`);
  html = html.replace(old1, new1);

  // 2. Close tab-profile + add 4 panels before breed-main ends
  //    (10-space </div> closes related-breeds grid, 8-space closes breed-section, 6-space closes breed-main)
